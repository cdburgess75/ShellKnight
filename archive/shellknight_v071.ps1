...
<#
.SYNOPSIS
    ShellKnight v0.71  -  Enterprise Endpoint Security & Remediation Tool
...
Write-Host ("  ShellKnight v0.71  |  $env:COMPUTERNAME  |  $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')  |  PS $($PSVersionTable.PSVersion.Major).$($PSVersionTable.PSVersion.Minor)") -ForegroundColor Cyan
Write-Host ("  " + ("=" * 78)) -ForegroundColor Cyan
Write-Host ""
