...
<#
.SYNOPSIS
    Dave's CleanSweep v0.46 — Enterprise PUP, Adware & Malware IOC Remediation Tool
...
.NOTES
    ...
    v0.46 — Fixed Set-StrictMode PropertyNotFoundException on scheduled task
            ...
            PSObject.Properties guard added to all Execute references in
            Phases 6 task removal and IOC path detection.
    v0.45 — Fixed Set-StrictMode PropertyNotFoundException on registry entries
            ...
            and InstallDate properties. PSObject.Properties guards added
            throughout Phases 4, 5, and 18.
...
if ($Script:HasGetScheduledTask) {
    ...
    $allTasks | Where-Object {
        ...
        ($_.Actions | Where-Object { $_.PSObject.Properties['Execute'] -and $_.Execute -and $Script:Targets.IsMatch($_.Execute) })
    } | ForEach-Object {
        try {
