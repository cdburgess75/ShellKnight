...
<#
.SYNOPSIS
    Dave's CleanSweep v0.62  -  Enterprise PUP, Adware & Malware IOC Remediation Tool
...
Write-Host "  Dave's CleanSweep v0.62" -ForegroundColor Cyan
...
function Write-Log {
    ...
    if ($Script:LogReady -and $Script:LogWriter -and -not $Script:LogWriter.BaseStream -eq $null) {
