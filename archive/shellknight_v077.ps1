...
<#
.SYNOPSIS
    ShellKnight v0.77  -  Enterprise Endpoint Security & Remediation Tool
...
Write-Host ("  ShellKnight v0.77  |  $env:COMPUTERNAME  |  $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')  |  PS $($PSVersionTable.PSVersion.Major).$($PSVersionTable.PSVersion.Minor)") -ForegroundColor Cyan
Write-Host ("  " + ("=" * 78)) -ForegroundColor Cyan
Write-Host ""
...
# ScreenConnect Phase 15b duplicate suppression flag (set in Phase 15b if rogue removed)
if ($Script:RogueScreenConnectRemoved) {
    Log-Info "ScreenConnect  -  rogue instance was removed in Phase 15b  -  Event 7045 IOC suppressed"
}
